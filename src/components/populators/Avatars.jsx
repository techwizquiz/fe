    ...
    <>
      ...
      <div>
        <label className={styles.label}>
          <input type="radio" name="avatar" value="monster" defaultChecked className={styles.radioButton} />
          <img className={styles.img} src={monster} />
        </label>
        <label className={styles.label}>
          <input type="radio" name="avatar" value="youngWizard" className={styles.radioButton} /> 
          <img className={styles.img} src={youngWizard} />
        </label>
        <label className={styles.label}>
          <input type="radio" name="avatar" value="goblin" className={styles.radioButton} />
          <img className={styles.img} src={goblin} />
        </label>
        <label className={styles.label}>
          <input type="radio" name="avatar" value="skullWizard" className={styles.radioButton} />
          <img className = {styles.img} src={skullWizard} />
        </label>
        <label className={styles.label}>
          <input type="radio" name="avatar" value="octopus" className={styles.radioButton} />
